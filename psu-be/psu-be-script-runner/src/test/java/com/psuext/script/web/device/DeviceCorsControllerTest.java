...
class DeviceCorsControllerTest extends DeviceManagerControllerTestSupport {

    @Test
    void permitsTheViteDevelopmentOriginToReadDevices() {
        restClient.options().uri("/api/devices")
